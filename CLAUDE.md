...
- **Always read `prompts/PLANNING.md`** at the start of a new conversation to understand the project's architecture, goals, style, and constraints.
...
### ✅ Task Completion
- **Mark completed tasks in `prompts/TASK.md`** immediately after finishing them.
- Add new sub-tasks or TODOs discovered during development to `prompts/TASK.md` under a “Discovered During Work” section.
...
- **Never delete or overwrite existing code** unless explicitly instructed to or if part of a task from `prompts/TASK.md`.